...
class StreamNuScenesDataset(Custom3DDataset):
    r"""NuScenes Dataset.
        ...
        if self.modality['use_camera']:
            ...
            if self.use_sequence_group_flag:
                ...
                if not input_dict['start_of_sequence']:
                    ...
                    input_dict['prev_ego_to_global_rt'] = torch.FloatTensor(nuscenes_get_rt_matrix(
                        self.data_infos[index - 1], self.data_infos[index],
                        "ego", "global")) # TODO: Note that global is same for all.
                else:
