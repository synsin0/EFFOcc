...
class LoadOpenOccupancy(object):
    ...
    def __call__(self, results):
        rel_path = 'scene_{0}/occupancy/{1}.npy'.format(results['curr']['scene_token'], results['curr']['lidar_token'])
        ...
        results['voxel_semantics'] = processed_label
