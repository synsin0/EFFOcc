...
class Collect3D(object):
    ...
    def __init__(
        ...
        meta_keys=('filename', 'ori_shape', 'img_shape', 'lidar2img',
                   ...
                   'affine_aug', 'sequence_group_idx', 'curr_to_prev_lidar_rt', 'curr_to_prev_ego_rt',
                    'start_of_sequence', 'index', 'global_to_curr_lidar_rt', 'scene_token', 'sample_token', 'use_with_label',
                    'prev_lidar_to_global_rt', 'sample_index', 'ego_pose_inv', 'ego_pose','timestamp', 'has_valid_map', 'instance_inds','ego2global')):
        self.keys = keys
