...
# https://github.com/open-mmlab/mmdetection/blob/ca11860f4f3c3ca2ce8340e2686eeaec05b29111/mmdet/core/hook/ema.py
import math
...
class BaseEMAHook(Hook):
    ...
    def before_run(self, runner):
        ...
        if self.checkpoint is not None:
            runner.resume(self.checkpoint, resume_optimizer=self.resume_optimizer)
