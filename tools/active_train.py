...
from mmdet3d.apis import init_random_seed, active_train_model
from mmdet3d.datasets import build_dataset, build_dataset_label_unlabelled, build_dataset_label_unlabelled_sequences
...
def main():
    ...
    if args.resume_from is not None:
        ...
        latest_path = osp.join('./work_dirs',
    ...
    logger.info(f'Model:\n{model}')
    # datasets = build_dataset_label_unlabelled(cfg.data.train)
    datasets = build_dataset_label_unlabelled_sequences(cfg.data.train)
