...
model = dict(
    ...
    teacher_ckpt = 'work_dirs/flashocc_fusion_r18_base_100%_seqs/epoch_42_ema.pth',
    inherit_head=True,
...
# ===> bus - IoU = 39.83
# ===> car - IoU = 47.19
# ===> construction_vehicle - IoU = 20.08
# ===> motorcycle - IoU = 17.26
# ===> pedestrian - IoU = 19.26
# ===> traffic_cone - IoU = 19.18
# ===> trailer - IoU = 29.77
# ===> truck - IoU = 33.75
# ===> driveable_surface - IoU = 79.2
# ===> other_flat - IoU = 39.55
# ===> sidewalk - IoU = 48.95
# ===> terrain - IoU = 52.95
# ===> manmade - IoU = 38.93
# ===> vegetation - IoU = 33.4
# ===> mIoU of 6019 samples: 34.3
# {'others': 8.36, 'barrier': 41.56, 'bicycle': 13.93, 'bus': 39.83, 'car': 47.19, 'construction_vehicle': 20.08, 'motorcycle': 17.26, 'pedestrian': 19.26, 'traffic_cone': 19.18, 'trailer': 29.77, 'truck': 33.75, 'driveable_surface': 79.2, 'other_flat': 39.55, 'sidewalk': 48.95, 'terrain': 52.95, 'manmade': 38.93, 'vegetation': 33.4, 'mIoU': 34.3}
