...
# ===> bus - IoU = 58.33
# ===> car - IoU = 65.39
# ===> construction_vehicle - IoU = 32.85
# ===> motorcycle - IoU = 38.5
# ===> pedestrian - IoU = 57.82
# ===> traffic_cone - IoU = 38.81
# ===> trailer - IoU = 48.75
# ===> truck - IoU = 51.54
# ===> driveable_surface - IoU = 83.08
# ===> other_flat - IoU = 44.46
# ===> sidewalk - IoU = 56.86
# ===> terrain - IoU = 60.42
# ===> manmade - IoU = 71.35
# ===> vegetation - IoU = 70.37
# ===> mIoU of 6019 samples: 51.49
# {'others': 12.79, 'barrier': 58.94, 'bicycle': 25.08, 'bus': 58.33, 'car': 65.39, 'construction_vehicle': 32.85, 'motorcycle': 38.5, 'pedestrian': 57.82, 'traffic_cone': 38.81, 'trailer': 48.75, 'truck': 51.54, 'driveable_surface': 83.08, 'other_flat': 44.46, 'sidewalk': 56.86, 'terrain': 60.42, 'manmade': 71.35, 'vegetation': 70.37, 'mIoU': 51.49}
